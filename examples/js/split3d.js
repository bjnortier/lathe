...
requirejs([
    ...
    new Split3DExample(
        new Polygon3D(new Plane3D(0,0,-1,1.666666666666667),[new Plane3D(-0.816496580927726,0.47140452079103157,0.3333333333333333,1.6666666666666667),new Plane3D(0,1,0,20),new Plane3D(-1,0,0,20),new Plane3D(0,-1,0,20)]),
        new Plane3D(-0.7071067811865477,0.408248290463863,-0.5773502691896257,2.8867513459481295));
