...
requirejs([
  ...
  // new Split3DExample(
  //   new Polygon3D(new Plane3D(0,0,1,10),[
  //     new Plane3D(0.6565096192647729,0.6565096192647729,0.37147037516556536,19.247888121748677),
  //     new Plane3D(0.7760132217981928,0.20793211609669945,0.5954558881142562,19.395502156139422),
  //     new Plane3D(0,1,0,1000000)]),
  //   new Plane3D(0.5680811057014935,0.5680811057014933,0.5954558881142562,19.395502156139425));

  new Split3DExample(
    new Polygon3D(new Plane3D(0.1304464340209961,-0.03495301678776741,0.9908390641212463,4.954195022583008),[
      new Plane3D(1,0,0,1000000),
      new Plane3D(0,1,0,1000000),
      new Plane3D(-1,0,0,1000000),
      new Plane3D(0,-1,0,1000000)
    ]),
    new Plane3D(0.1304464340209961,-0.03495301678776741,0.9908390641212463,4.954195022583008));

  // new Split3DExample(
  //   new Polygon3D(new Plane3D(0,0,1,10),[
  //     new Plane3D(0.776013,0.207932,0.595455,19.395502),
  //     new Plane3D(0.568081,0.568081,0.595455,19.395502),
  //     new Plane3D(0.207932,0.776013,0.595455,19.395502),
  //     new Plane3D(-0.207933,0.776013,0.595455,19.395502),
  //     new Plane3D(-0.568082,0.568081,0.595455,19.395502),
  //     new Plane3D(-1,0,0,1000000),
  //     new Plane3D(0,-1,0,1000000)
  //   ]),
  //   new Plane3D(-0.207933,0.776013,0.595455,19.395502));
