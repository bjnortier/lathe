define([
  ...
  Node.prototype.translate = function(dx, dy, dz) {
    ...
    if (v.back.translate) {
      v.back = v.back.translate(dx, dy, dz);
    }
    if (v.front.translate) {
      v.front = v.front.translate(dx, dy, dz);
    }
    if (v.shp) {
  ...
  Node.prototype.rotate = function(axisx, axisy, axisz, angle) {
    ...
    if (v.back.translate) {
      v.back = v.back.rotate(axisx, axisy, axisz, angle);
    }
    if (v.front.translate) {
      v.front = v.front.rotate(axisx, axisy, axisz, angle);
    }
    if (v.shp) {
  ...
  Node.prototype.scale = function(factor) {
    ...
    if (v.back.translate) {
      v.back = v.back.scale(factor);
    }
    if (v.front.translate) {
      v.front = v.front.scale(factor);
    }
    if (v.shp) {
