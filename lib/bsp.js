...
define([
  ...
  // Translate and return new node
  Node.prototype.translate = function(dx, dy, dz, dontRecreateSHPs) {
    var v =  this.clone();
    v.plane = v.plane.translate(dx, dy, dz);
    v.back.translate && (v.back = v.back.translate(dx, dy, dz, true));
    v.front.translate && (v.front = v.front.translate(dx, dy, dz, true));
