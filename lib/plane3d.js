...
define([
    ...
    var Plane3D = function(a,b,c,d) {
      ...
      this.a = this.equation[0];
      this.b = this.equation[1];
      this.c = this.equation[2];
      this.d = this.equation[3];
    ...
    // Create from 3 points and a normal
    Plane3D.fromPoints = function(a,b,c,normal) {
      var ab = b.sub(a);
      var ac = c.sub(a);
      var normal = ab.cross(ac).normalize();
      var d = (a.x*normal.x + a.y*normal.y + a.z*normal.z);
